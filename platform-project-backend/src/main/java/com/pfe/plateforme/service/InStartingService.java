...
public class InStartingService {
	...
	public void initDatabase() {
		...
		etudiant6.setNom("EL GHARAS");
		etudiant6.setPrenom("Mohamed");
		etudiant6.setFiliere(smi);
		etudiant6.setEmail("elgharas.mohamed@etu.uae.ac.ma");
		etudiant6.setPassword(getEncodedPassword("mohamed123"));
		...
		etudiant8.setNom("KAMALI");
		etudiant8.setPrenom("Mohsen");
		etudiant8.setFiliere(smi);
		etudiant8.setEmail("mohsen.kamali@etu.uae.ac.ma");
